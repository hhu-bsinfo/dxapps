...
public class TcmdChunkput extends AbstractTerminalCommand {
    ...
    public void exec(final TerminalCommandString p_cmd, final TerminalServerStdout p_stdout, final TerminalServerStdin p_stdin,
        ...
        if (isChunkId) {
            ...
            data = p_cmd.getArgument(1, null);
            type = p_cmd.getArgument(2, "str").toLowerCase();
            offset = p_cmd.getArgument(3, Integer::valueOf, -1);
        } else {
            ...
            data = p_cmd.getArgument(2, null);
            type = p_cmd.getArgument(3, "str").toLowerCase();
            offset = p_cmd.getArgument(4, Integer::valueOf, -1);
        }
        ...
        if (chunkService.getAnon().get(chunks, cid) != 1) {
        ...
        // put chunk back
        if (chunkService.putAnon().put(chunk) != 1) {
