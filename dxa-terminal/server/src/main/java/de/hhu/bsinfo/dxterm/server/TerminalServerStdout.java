...
public class TerminalServerStdout {
    ...
    public void printErr(final String p_str) {
        m_session.write(new TerminalStdoutData(p_str, de.hhu.bsinfo.dxterm.TerminalColor.RED, de.hhu.bsinfo.dxterm.TerminalColor.DEFAULT, de.hhu.bsinfo.dxterm.TerminalStyle.NORMAL));
    }
    ...
    public void printlnErr(final String p_str) {
        m_session.write(new TerminalStdoutData(p_str + '\n', de.hhu.bsinfo.dxterm.TerminalColor.RED, de.hhu.bsinfo.dxterm.TerminalColor.DEFAULT, de.hhu.bsinfo.dxterm.TerminalStyle.NORMAL));
    }
    ...
    public void printfErr(final String p_format, final Object... p_args) {
        m_session.write(new TerminalStdoutData(String.format(p_format, p_args), de.hhu.bsinfo.dxterm.TerminalColor.RED, de.hhu.bsinfo.dxterm.TerminalColor.DEFAULT, de.hhu.bsinfo.dxterm.TerminalStyle.NORMAL));
    }
    ...
    public void printflnErr(final String p_format, final Object... p_args) {
        m_session.write(new TerminalStdoutData(String.format(p_format + '\n', p_args), de.hhu.bsinfo.dxterm.TerminalColor.RED, de.hhu.bsinfo.dxterm.TerminalColor.DEFAULT, de.hhu.bsinfo.dxterm.TerminalStyle.NORMAL));
    }
